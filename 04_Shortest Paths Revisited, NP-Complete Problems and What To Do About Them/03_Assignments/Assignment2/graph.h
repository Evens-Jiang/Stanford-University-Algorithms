...
adjlist_node_p createNode(int v, double distance)
{
...
void addEdge(graph_t *graph, int src, int dest, double distance)
{
    /* Add an edge from src to dst in the adjacency list*/
    adjlist_node_p newNode = createNode(dest, distance);
